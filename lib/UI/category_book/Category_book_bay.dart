    ...
    Widget counterButton(String icon){
      return OutlinedButton(
          ...
          child: Container(
            ...
            child: Text(icon, style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30,color: Colors.black),      ),
          )
      );
    }
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
              child: Image.network("https://img.freepik.com/premium-psd/book-cover-mockup_125540-572.jpg?w=2000"),
            ),
            Container(
            ...
            Container(
                padding: EdgeInsets.only(left: 12),
                child: Text("ລາຍລະອຽດ",style: TextStyle(fontSize: 20,color: Colors.black),)),
            Container(
                padding: EdgeInsets.only(left: 12),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text("ຈຳນວນ",style: TextStyle(fontSize: 25),),
                  SizedBox(width: 20,),
                  counterButton('-'),
                  SizedBox(width: 20,),
                  Text("1",style: TextStyle(fontSize: 22,fontWeight: FontWeight.w400),),
                  SizedBox(width: 20,),
                  counterButton('+')],
              ),
            ),
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context)=>Play_Ment_Detail()));
                    }, child: Container(
                    width: 100,
                    height: 50,
                    ...
                    child: const Center (
                        child: Text('ຊື້ເລີຍ',style: TextStyle(fontSize: 25,color: Colors.white),)
                    ),),
                  ),
                  SizedBox(width: 100,),
                  Container(
                    ...
                    child: const Center (
                        child: Text('ໃສ່ກະຕ່າ',style: TextStyle(fontSize: 25,color: Colors.white),)
                    ),),
                ],
              ),
            )
